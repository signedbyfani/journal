...
export default defineConfig({
  adapter: netlify({
    imageCDN: false
  }), // Disable Netlify image CDN so built assets load on any host
  ...
  markdown: {
    ...
    rehypePlugins: [rehypeKatex, rehypeCleanup, rehypeImageProcessor, rehypeCopyCode, rehypeExternalLinks]
  },
  integrations: [
    playformInline({
